...
- **WHEN** `skittle source add` is pointed at `fixtures/single-skill/SKILL.md`
...
- **WHEN** `skittle source add` is pointed at `fixtures/flat-skills/`
...
- **WHEN** `skittle source add` is pointed at `fixtures/plugin-source/`
...
- **WHEN** `skittle source add` is pointed at `fixtures/full-source/`
